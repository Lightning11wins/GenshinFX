...
execute unless score !claymoreDomain counter matches 1.. in genshin:abyss run summon armor_stand -4050 124 1036 {NoGravity:1,Silent:1,Invulnerable:1,Marker:1,Invisible:1,Tags:["domainClaymoreIron","system","center","transient"]}
